...
该配置文件在 macOS 版本 **10.14.2~10.14.6** 全部亲自测试安装成功（全新安装/系统内 OTA 更新）；初步支持 10.15 Beta 7；使用 Clover Hotpatch 驱动。
